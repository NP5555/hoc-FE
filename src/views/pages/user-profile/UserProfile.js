...
import KYC from 'src/views/pages/user-profile/kyc'
...
import Password from 'src/views/pages/user-profile/password'
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  <Tab
                    value='kyc'
                    label={
                      <Box sx={{ display: 'flex', color: 'black', alignItems: 'center', ...(!hideText && { '& svg': { mr: 2 } }) }}>
                  ...
                  />
                   <Tab
                    ...
                    label={
                      <Box sx={{ display: 'flex', color: 'black', alignItems: 'center', ...(!hideText && { '& svg': { mr: 2 } }) }}>
                        <Icon fontSize='1.125rem' icon='material-symbols:password' />
